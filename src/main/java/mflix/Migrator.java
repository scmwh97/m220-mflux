...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix-0y8ue.mongodb.net/test?retryWrites=true&w=majority";
        ...
        // format pattern
        // Bson queryFilter =  new Document("lastupdated", new Document("$type", 2L));
